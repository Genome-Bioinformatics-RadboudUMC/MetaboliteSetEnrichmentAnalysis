package org.umcn.tml.shared.textmining;
...
//Found at: https://github.com/harryaskham/Twitter-L-LDA/blob/master/util/Stopwords.java
public class Stopwords {
	...
	public static String stemString(String string) {
		...
		porterStemmer.add(string.toCharArray(), string.length());
		porterStemmer.stem();
	...
	public static Set<String> stemStringSet(Set<String> stringSet) {
		...
		for(String string : stringSet) {
			...
			porterStemmer.add(string.toCharArray(), string.length());
			porterStemmer.stem();
			results.add(porterStemmer.toString());
		}
		return results;
	}
}
